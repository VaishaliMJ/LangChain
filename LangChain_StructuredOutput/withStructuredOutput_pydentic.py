"""----------------------------------------------------------------------------------
    Problem Statement   :   Basic Langchain model with pydentic
...
class Review(BaseModel):
    keyThemes     :   list[str]=Field(description="Write down all the key themes discussed in review in a list")
    summary     :   str=Field(description="A brief summary of the rewiew")
