...
###############################################################################
#   Function        :   formatDocs
#   Input Params    :   retrievedDocs
#   Output Params   :   context text
#   Description     :   Format Retrieved Documents
#   Author          :   Vaishali M Jorwekar
###############################################################################
def formatDocs(retrievedDocs):
...
def main():
    ...
    #parallelChain.invoke('who is Demis')
